public abstract class TaulellUtils {
    ...
    public static boolean validarCasellaDesti(int filaDesti, int columnaDesti, String colorJugador, Taulell taulell) {
        ...
        // Si no pasa por ningún if, significa que hay una ficha enemiga, y es posible moverse
        return true;
    }

    
    public static void moureFitxa(int filaInicial, int columnaInicial, int filaDesti, int columnaDesti, Taulell taulell) {
        Fitxa[][] fitxes = taulell.getTaulell();
